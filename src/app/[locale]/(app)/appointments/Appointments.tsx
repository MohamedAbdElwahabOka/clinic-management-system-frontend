...
const initialAppointments: Appointment[] = [
  { id: 1, patientName: "محمد علي", phone: "0101234567", date: "2025-12-07", time: "10:00", status: "pending", type: "consultation" },
  { id: 2, patientName: "سارة محمود", phone: "0109876543", date: "2025-12-07", time: "11:30", status: "confirmed", type: "followup" },
  { id: 3, patientName: "علي حسن", date: "2025-12-07", time: "14:00", status: "pending", type: "consultation" },
  { id: 4, patientName: "فاطمة أحمد", date: "2025-12-08", time: "09:00", status: "confirmed", type: "emergency" },
  { id: 5, patientName: "يوسف محمد", date: "2025-12-08", time: "15:30", status: "pending", type: "consultation" },
];
  ...
  const filteredAppointments = useMemo(() => {
    return appointments
      .filter(appt => {
        ...
        if (searchText && !appt.patientName.toLowerCase().includes(searchText.toLowerCase())) return false;
        return true;
      })
      .sort((a, b) => a.time.localeCompare(b.time));
  }, [appointments, selectedDate, searchText]);
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-white border-b sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <h1 className="text-xl font-bold text-gray-900 mb-3">المواعيد</h1>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pr-10 pl-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white"
            />
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl p-3 border flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="text-center font-medium text-gray-900 border-none outline-none bg-transparent"
            />
            {isToday(selectedDate) && (
              <span className="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full">اليوم</span>
            )}
          </div>
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="text-left">
                    <div className="text-sm font-medium text-gray-900">{appt.time}</div>
                ...
                <div className="flex gap-2">
                  {appt.status === 'pending' && (
                    <>
                      <button
                        ...
                        className="flex-1 py-2 px-3 bg-green-50 text-green-700 rounded-lg text-sm font-medium hover:bg-green-100 flex items-center justify-center gap-1.5"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 py-2 px-3 bg-red-50 text-red-700 rounded-lg text-sm font-medium hover:bg-red-100 flex items-center justify-center gap-1.5"
                      >
                        <X className="w-4 h-4" />
                        إلغاء
                      </button>
                  ...
                  {appt.status === 'confirmed' && (
                    <button
                      ...
                      className="w-full py-2 px-3 bg-blue-50 text-blue-700 rounded-lg text-sm font-medium hover:bg-blue-100"
                    >
                      إكمال الموعد
                    </button>
                  )}
                  {appt.status === 'completed' && (
                    <div className="w-full py-2 px-3 bg-gray-50 text-gray-600 rounded-lg text-sm text-center">
                      تم الإكمال ✓
                    </div>
                  )}
                  {appt.status === 'canceled' && (
                    <div className="w-full py-2 px-3 bg-red-50 text-red-600 rounded-lg text-sm text-center">
                      ملغي
                    </div>
                  )}
                </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-end sm:items-center justify-center p-4">
          <div className="bg-white rounded-t-3xl sm:rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b px-4 py-4 flex items-center justify-between">
              <h2 className="text-lg font-bold">موعد جديد</h2>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    <button
                      key={type.value}
                      onClick={() => setNewAppt({...newAppt, type: type.value as any})}
      ...
      {selectedAppt && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-end sm:items-center justify-center p-4" onClick={() => setSelectedAppt(null)}>
          <div className="bg-white rounded-t-3xl sm:rounded-2xl w-full max-w-md" onClick={(e) => e.stopPropagation()}>
            <div className="p-4 border-b">
              <div className="flex items-start justify-between">
                <div>
                  <h2 className="text-xl font-bold text-gray-900">{selectedAppt.patientName}</h2>
                  {selectedAppt.phone && (
                    <a href={`tel:${selectedAppt.phone}`} className="text-blue-600 text-sm mt-1 flex items-center gap-1">
