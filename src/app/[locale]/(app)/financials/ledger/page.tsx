          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-end">
            ...
            <div className="w-full">
                ...
                <Select value={filterType} onValueChange={(value) => setFilterType(value as LedgerEntryType | "all")}> 
                  <SelectTrigger id="type-filter" className="mt-1 w-full">
            ...
            <Button onClick={handleClearFilters} variant="outline" className="w-full md:w-auto">{translate('clearFilters', 'Clear Filters')}</Button>
          </CardContent>
        </Card>
