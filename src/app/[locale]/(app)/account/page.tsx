...
export default function AccountPage() {
  ...
  return (
    ...
    <div className="w-full max-w-full overflow-x-hidden space-y-4 md:space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-24 md:pb-0 relative">
