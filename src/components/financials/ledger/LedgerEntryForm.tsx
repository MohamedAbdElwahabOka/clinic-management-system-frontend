...
export function LedgerEntryForm({
  ...
  // Schema الفورم مع تعديل categoryId ليقبل undefined
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
            ...
            <div className="flex justify-end space-x-2 rtl:space-x-reverse pt-4">
              <Button
                type="button"
                variant="outline"
                onClick={handleClearAndResetForm}
              ...
              >
                ...
                {isEditing ? translate("updateEntry") : translate("addEntry")}
              </Button>
            </div>
          </form>
        </Form>
...
//         ),
//       })
//       .optional(), // هنا أصبح optional لدعم undefined
//     amount: z.coerce.number().positive(translate("errorAmountPositive")),
//     type: z.enum(["income", "expense"], {
//       required_error: translate(
//         "requiredField",
